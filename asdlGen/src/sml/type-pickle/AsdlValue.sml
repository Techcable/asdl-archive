...
structure AsdlValue : AsdlValue_SIG = 
    ...
    and write_tagged_prim_value x s = 
            ((write_tag 28 s); (write_prim_value x s))
    and read_prim_value s = 
            (case ((read_tag s)) of 
                ...
                | _ => (die ()))
    and read_tagged_prim_value s = 
            (case ((read_tag s)) of 
                  28 => (read_prim_value s)
                | _ => (die ()))
    ...
    and write_tagged_asdl_value x s = 
            ((write_tag 27 s); (write_asdl_value x s))
    and read_asdl_value s = 
            (case ((read_tag s)) of 
                ...
                | _ => (die ()))
    and read_tagged_asdl_value s = 
            (case ((read_tag s)) of 
                  27 => (read_asdl_value s)
                | _ => (die ()))
