...
functor X86SchedProps(structure Instr : X86INSTR
...
struct
   ...
   exception X86StructuralHazard
   exception StructuralHazard = X86StructuralHazard
   fun error msg = MLRiscErrorMsg.error("X86SchedProps",msg)
   ...
   fun move{src=I.Direct rs,dst=I.Direct rd} =
        [I.COPY{src=[rs], dst=[rd], tmp=NONE}]
   fun fmove{src=I.FDirect rs,dst=I.FDirect rd} =
        [I.FCOPY{src=[rs], dst=[rd], tmp=NONE}]
