(*
 * This signature describes the interface for extracting information
 * for performating predicate based optimizations.
 *
 * -- Allen
 *)
...
sig
   ...
   and pred_opn = REG of I.C.cell
                | IMMED of int
                | OTHER_IMMED of int

   datatype predicate_instr =
     DEF   of I.C.cell * pred_expr
   | OTHER of {defs:I.C.cell list,uses:I.C.cell list}
    ...
    *========================================================================*)
   val info : I.predicate -> {r:I.C.cell, neg:bool} option
